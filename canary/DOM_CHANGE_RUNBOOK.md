...
3. In the trace, find the click on the `Select <login>` row and the following `POST /switch_account` request. Check the response status plus `Set-Cookie`.
